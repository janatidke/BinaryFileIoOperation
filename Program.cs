...
namespace BinaryFileIoOperation
{
        ...
        class BinaryTesting
        {
            ...
            {
                fs = new FileStream(@"/Users/acer/Desktop/stud.Dat", FileMode.Open, FileAccess.Write);
            ...
            {
                fs = new FileStream(@"/Users/acer/Desktop/stud.Dat", FileMode.Open, FileAccess.Read);
